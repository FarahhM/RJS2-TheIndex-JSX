                ...
                <div class="col-lg-4 col-md-6 col-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <small class="card-text">{authors[0].books.length}</small>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6 col-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <small class="card-text">{authors[1].books.length}</small>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6 col-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <small class="card-text">{authors[2].books.length}</small>
                    </div>
                  </div>
                </div>
                <div class="col-lg-4 col-md-6 col-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <small class="card-text">{authors[3].books.length}</small>
                    </div>
                  </div>
                </div>
              </div>
